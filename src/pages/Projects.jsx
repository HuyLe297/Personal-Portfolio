          ...
          <div className="group bg-slate-700 rounded-xl overflow-hidden shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                <a href="https://drive.google.com/file/d/1DCbjEOw3PQoY4KOmNgA90bnmbJ0ZROVt/view?usp=sharing" className="flex-1 bg-sky-600 text-white py-2 px-4 rounded-lg text-center font-medium transition-all hover:bg-sky-500">
                  Live Demo
                </a>
