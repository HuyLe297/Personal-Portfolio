...
import jobfinderaiImg from '../assets/jobfinderai.jpg';
      ...
      <div className="text-center max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-slate-700 rounded-xl overflow-hidden shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl">
            ...
            />
            <div className="p-6">
              <h3 className="text-2xl font-bold text-white mb-2">JobFinder AI</h3>
              <p className="text-gray-300 mb-4">
                Ứng dụng tìm việc thông minh dùng AI, gợi ý công việc theo CV, React + Node.js.
              </p>
              <div className="flex gap-3">
                ...
                <a href="https://github.com/HuyLe297/JobFinderAI" className="flex-1 bg-gray-600 text-white py-2 px-4 rounded-lg text-center font-medium transition-all hover:bg-gray-500">
                  GitHub
                </a>
              </div>
            </div>
